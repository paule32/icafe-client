...
$(function(){
	...
	$(".equals-button").click(function(){
		...
		if (($("#display").data("valueOneLocked") == true) && ($("#display").data("valueTwoLocked") == true)) {
			...
			if ($("#display").data("thePendingFunction") == "+") {
				var num1 = parseFloat($("#display").data("valueOne"));
        var num2 = parseFloat($("#display").data("valueTwo"));
        var finalValue = (num1 + num2);
    ...
    $('#appdeck', window.parent.document).show();
    $('#subview', window.parent.document).hide();
	});
